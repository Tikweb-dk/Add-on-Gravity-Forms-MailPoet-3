<?php
class GFMailpoetData{

    public static function update_table(){
        global $wpdb;
        $table_name = self::get_mailpoet_table_name();
    ...
    public static function get_mailpoet_table_name(){
        global $wpdb;
        return $wpdb->prefix . "rg_mailpoet";
    }
    ...
    public static function drop_tables(){
        global $wpdb;
        $wpdb->query("DROP TABLE IF EXISTS " . self::get_mailpoet_table_name());
    }
}
?>
